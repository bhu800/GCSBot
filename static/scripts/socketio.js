$(document).ready(function(){
    ...
    function printUserMsg(msg) {
        ...
        var user_icon = $('<div class="msg-img" style="background-image: url(\'../static/images/user.svg\')"></div>')
    ...
    function printBotMsg(msg) {
        ...
        var bot_icon = $('<div class="msg-img" style="background-image: url(\'../static/images/bot.svg\')"></div>')
